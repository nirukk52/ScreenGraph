...
export namespace steering {
    ...
    export class ServiceClient {
        ...
        public async getDoc(params: { category: string, filename: string }): Promise<ResponseType<typeof api_steering_get_doc_getDoc>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/steering/docs/${encodeURIComponent(params.category)}/${encodeURIComponent(params.filename)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_steering_get_doc_getDoc>
        }

        public async listDocs(): Promise<ResponseType<typeof api_steering_list_docs_listDocs>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/steering/docs`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_steering_list_docs_listDocs>
        }

        public async updateDoc(params: RequestType<typeof api_steering_update_doc_updateDoc>): Promise<ResponseType<typeof api_steering_update_doc_updateDoc>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_steering_update_doc_updateDoc>
        }
    }
}
